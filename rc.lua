...
globalkeys = awful.util.table.join(
    ...
    -- Prompt
    awful.key({ modkey }, "r", function () os.execute("rofi -show run -font 'Hack 10' -lines 3 -eh 2 -width 20") end,
...
runOnce.run("compton")
runOnce.run("google-chrome-stable")
runOnce.run("steam")
runOnce.run("streamlink-twitch-gui")
